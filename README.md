...
2026-07-24 起进入 **封锁城区可交付版收敛阶段**：暂停第二至第五竞技场扩展，按 BC-01～BC-05 依次完成正式单区流程、玩法深化、美术、音频、平衡、稳定性和 Windows 构建。

BC-01～BC-04 已通过用户验收。当前进入 BC-05「最终功能回归与 Windows 构建」，并补充 BC-05A Debug 策划节奏调参台；仍只收敛封锁城区，不扩展第二竞技场。性能跑分已按 2026-07-27 用户确认延期为独立迭代。
...
Windows Release 构建与交付说明见 [`docs/release/BC05-WINDOWS-RC1.md`](docs/release/BC05-WINDOWS-RC1.md)。
